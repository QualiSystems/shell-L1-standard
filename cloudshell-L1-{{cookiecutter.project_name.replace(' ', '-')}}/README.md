...
Shell version: {{cookiecutter.shell_version}}
...
### **{{cookiecutter.shell_name}}**
The {{cookiecutter.model_name}} L1 shell provides you with the capability to communicate with network topology managed by the {{cookiecutter.model_name}} switch.
...
The **{{cookiecutter.model_name}}** L1 shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 
